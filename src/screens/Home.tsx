...
export default function Home() {
    ...
    return (
        <div>
            ...
            <div className="h-16 w-16 bg-amber-400 fixed bottom-8 right-8">
                <svg fill="#000000" width="800px" height="800px" viewBox="0 0 24 24" id="up-arrow" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg" class="icon flat-color"><path id="primary" d="M15.71,5.29l-3-3a1,1,0,0,0-1.42,0l-3,3A1,1,0,0,0,9.71,6.71L11,5.41V21a1,1,0,0,0,2,0V5.41l1.29,1.3a1,1,0,0,0,1.42,0A1,1,0,0,0,15.71,5.29Z" style="fill: rgb(0, 0, 0);"></path></svg>
            </div>
