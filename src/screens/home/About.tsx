        ...
        <Container>
            ...
            <div className="h-24 bg-[#d1dfe0] flex px-5 py-3 mt-4 justify-between">
                <div className="flex flex-col justify-center">
                    <p className='m-0 p-0'>Start your learning journey with VirtualTech Academy</p>
                    <h2>Master the skills of future</h2>
                </div>
                <div className='bg-[#06BBCC] py-2 px-5 rounded-4xl cursor-pointer text-3xl font-semibold text-white flex items-center justify-center'>
                    Enroll Now
                </div>
            </div>
        </Container>
